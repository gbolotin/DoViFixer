...
{
    public static async Task<T> RunAsync<T>(ILogger logger, string operation, Guid id, string? input, Func<Task<T>> execute, CancellationToken cancellationToken, Func<T, OperationStatus>? status = null)
    {
